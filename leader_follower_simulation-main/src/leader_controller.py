...
def get_model_state(model_name: str = 'jackal'):
...
class LeaderController:
    def __init__(self, leader_id: int = 1):
        ...
        rospy.Subscriber('/move_base/TebLocalPlannerROS/teb_feedback', FeedbackMsg, self.traj_callback)
    ...
    def stop(self, position, rotation):
        ...
        if dist < 0.05 and np.abs(dtheta) < 0.15:
