// Generated by gencpp from file LfH/Bspline.msg
// DO NOT EDIT!


#ifndef LFH_MESSAGE_BSPLINE_H
#define LFH_MESSAGE_BSPLINE_H
...
struct Bspline_
{
  ...
  typedef boost::shared_ptr< ::LfH::Bspline_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::LfH::Bspline_<ContainerAllocator> const> ConstPtr;

}; // struct Bspline_

typedef ::LfH::Bspline_<std::allocator<void> > Bspline;

typedef boost::shared_ptr< ::LfH::Bspline > BsplinePtr;
typedef boost::shared_ptr< ::LfH::Bspline const> BsplineConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::LfH::Bspline_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::LfH::Bspline_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::LfH::Bspline_<ContainerAllocator1> & lhs, const ::LfH::Bspline_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::LfH::Bspline_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::LfH::Bspline_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::LfH::Bspline_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::LfH::Bspline_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::LfH::Bspline_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::LfH::Bspline_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::LfH::Bspline_<ContainerAllocator> >
{
  ...
  static const char* value(const ::LfH::Bspline_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb352d4f7278a5461ULL;
  static const uint64_t static_value2 = 0x80de67cbe6793e49ULL;
};

template<class ContainerAllocator>
struct DataType< ::LfH::Bspline_<ContainerAllocator> >
{
  static const char* value()
  {
    return "LfH/Bspline";
...
template<class ContainerAllocator>
struct Definition< ::LfH::Bspline_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 order\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::LfH::Bspline_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::LfH::Bspline_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::LfH::Bspline_<ContainerAllocator>& v)
  {
    s << indent << "order: ";
